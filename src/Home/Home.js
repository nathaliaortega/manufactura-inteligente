  ...
  return (
    <div className="Home">
        <div className="Home-container">
            ...
            como asentamiento, resistencia a la compresión o resistencia a la flexión.<br/> 
            ...
            en el comportamiento de las variables estudiadas.  <br/>
            ...
            permite realizar la predicción de la resistencia a la compresión, asentamiento
             ...
             implementación en el sector de la manufactura para experimentos, nuevos desarrollos o desarrollos existentes.<br/>
